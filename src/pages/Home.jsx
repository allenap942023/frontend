...
const Home = ({ showNavbar }) => {
  return (
    <div className="bg-blue-800 text-white">
      ...
      <div id="div4" className="py-16 h-screen" style={{ backgroundImage: "url('/img/imagenes/dashboard5.jpg')", backgroundSize: "cover" }}>
      ...
      <div id="div5" className="h-screen grid grid cols-1 items-center justify-center" style={{ backgroundImage: "url('/img/imagenes/jadeazul.jpg')", backgroundSize: "cover" }}>
