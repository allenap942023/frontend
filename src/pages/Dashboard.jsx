...
const Dashboard = () => {
  ...
  <div class="max-w-4xl mx-auto px-6 py-12">
    ...
    <a href="/dashboard/search" class="inline-block bg-white text-blue-500 hover:bg-blue-600 text-lg md:text-xl font-medium py-3 px-6 rounded-lg transition duration-300 ease-in-out animate-pulse">Buscar Pacientes</a>
  </div>
</div>
      </div>
    </div>
