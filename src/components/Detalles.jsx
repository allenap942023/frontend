...
const Detalles = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row sm:flex-col xs:flex-col overflow-scroll" style={{ backgroundImage: "url('/img/imagenes/Sin título.png')", backgroundSize: "cover" }}>
